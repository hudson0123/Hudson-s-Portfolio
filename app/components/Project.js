...
export default function Project({ details, onMouseEnter, onMouseLeave}) {
    ...
    return (
        <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} className="max-w-lg bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <a
                href="#"
                className="inline-flex items-center pr-2 py-2 mb-3 ml-[450px] text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
                <svg
