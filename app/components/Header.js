...
export default function Header({ headerState, homeState }) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bg-[#1b1b11] text-[#DBDBDB] font-mono z-10 p-2 font-normal">
      <div className="grid grid-cols-2">
        ...
        <div className="hidden md:flex justify-end space-x-5">
          ...
          <button
            className="bg-transparent hover:bg-[#db624d] text-[#DBDBDB] hover:text-black px-4 py-0 border border-[#DBDBDB] hover:border-black rounded duration-300"
